...
{
    FRACTURED_NERF_GENERIC = 600000,
    FRACTURED_NERF_WARRIOR_ARMS,
    FRACTURED_NERF_WARRIOR_FURY,
    FRACTURED_NERF_WARRIOR_PROTECTION,
    FRACTURED_NERF_PALADIN_RETRIBUTION,
    FRACTURED_NERF_PALADIN_PROTECTION,
    FRACTURED_NERF_PALADIN_HOLY,
    FRACTURED_NERF_HUNTER_MARKSMANSHIP,
    FRACTURED_NERF_HUNTER_BEAST_MASTERY,
    FRACTURED_NERF_HUNTER_SURVIVAL,
    FRACTURED_NERF_ROGUE_SUBTLETY,
    FRACTURED_NERF_ROGUE_ASSASINATION,
    FRACTURED_NERF_ROGUE_COMBAT,
    FRACTURED_NERF_PRIEST_SHADOW,
    FRACTURED_NERF_PRIEST_HOLY,
    FRACTURED_NERF_PRIEST_DISCIPLINE,
    FRACTURED_NERF_DK_BLOOD,
    FRACTURED_NERF_DK_FROST,
    FRACTURED_NERF_DK_UNHOLY,
    FRACTURED_NERF_SHAMAN_ENHANCEMENT,
    FRACTURED_NERF_SHAMAN_ELEMENTAL,
    FRACTURED_NERF_SHAMAN_RESTORATION,
    FRACTURED_NERF_MAGE_FROST,
    FRACTURED_NERF_MAGE_FIRE,
    FRACTURED_NERF_MAGE_ARCANE,
    FRACTURED_NERF_WARLOCK_DESTRUCTION,
    FRACTURED_NERF_WARLOCK_AFFLICTION,
    FRACTURED_NERF_WARLOCK_DEMONOLOGY,
    FRACTURED_NERF_DRUID_BALANCE,
    FRACTURED_NERF_DRUID_FERAL,
    FRACTURED_NERF_DRUID_RESTORATION,
    FRACTURED_NERF_DRUID_GUARDIAN,
    FRACTURED_NERF_MONK_WINDWALKER,
    FRACTURED_NERF_MONK_BREWMASTER,
    FRACTURED_NERF_MONK_MISTWEAVER,
};

constexpr uint32 FRACTURED_NERF_SPELLS_BEGIN = 600000;
constexpr uint32 FRACTURED_NERF_SPELLS_END = 600035;
